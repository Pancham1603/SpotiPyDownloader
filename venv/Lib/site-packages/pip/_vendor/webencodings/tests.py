...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'***REMOVED***'], 'latin1') == '***REMOVED***'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == '***REMOVED***'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == '***REMOVED***'
